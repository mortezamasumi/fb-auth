...
use Mortezamasumi\FbAuth\Tests\Services\FbAuthPanelProvider;
...
class TestCase extends Orchestra
{
    protected function setUp(): void
    {
        ...
        //     fn (string $modelName) => 'Mortezamasumi\\FbAuth\\Database\\Factories\\'.class_basename($modelName).'Factory'
        // );
    }
