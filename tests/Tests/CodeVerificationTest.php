...
it('can resend the verification code from the prompt page', function () {
    ...
    Notification::assertSentTo($user, VerifyCodeNotification::class);
});
...
it('can verify a user when they enter correct code', function () {
    ...
    Notification::assertSentTo(
        $user,
        VerifyCodeNotification::class,
        function (VerifyCodeNotification $notification, array $channels, User $notifiable) use (&$code) {
